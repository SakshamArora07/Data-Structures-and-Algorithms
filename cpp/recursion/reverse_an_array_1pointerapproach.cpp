...
void reverse(int arr[], int start, int size_of_array){
    ...
    swap(arr[start], arr[size_of_array - start - 1]); // swap i th element and n-i-1 th element
    reverse(arr, start+1, size_of_array);
}
...
int main(){
    ...
    reverse(arr, start, size_of_array);
